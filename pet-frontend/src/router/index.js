...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'password', name: '前台修改密码', component: () => import('../views/front/Password.vue')},
      {
        path: 'home',
        name: 'FrontHome',
        component: () => import('../views/front/NewHomePage.vue')
      },
      {
        path: 'old-home',
        name: 'OldFrontHome',
...
export const setRoutes = () => {
  ...
  if (storeMenus) {
    ...
    const manageRoute = { path: '/', name: 'Manage', component: () => import('../views/Manage.vue'), redirect: "/login", children: [
        { path: 'person', name: '管理个人信息', component: () => import('../views/Person.vue')},
        { path: 'password', name: '管理修改密码', component: () => import('../views/Password.vue')},
      ] }
